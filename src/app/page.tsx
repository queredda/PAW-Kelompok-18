        ...
        <div className="flex flex-col-reverse items-center justify-between gap-16 py-16 lg:flex-row">
          <div className="max-w-xl lg:pl-12">
            <p className="font-poppins text-[36px] font-semibold leading-tight text-white md:text-start text-center">
              Track and Manage Your Company’s Assets with Ease
            </p>
            <p className="mb-8 text-[15px] pt-5 font-poppins text-base leading-relaxed text-white md:text-justify text-center">
              Platform kami menawarkan solusi intuitif untuk melacak dan
              mengelola aset perusahaan Anda secara efisien. Dari pengendalian
              inventaris hingga proses peminjaman yang lebih mudah, sistem kami
              menyederhanakan manajemen aset hanya dengan beberapa klik. Baik
              Anda seorang admin yang mengawasi operasional atau karyawan yang
              mengelola peminjaman aset pribadi, alat ini dirancang untuk
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-[#EA68AA] to-[#8F65BB] p-8 shadow-lg transition-transform hover:-translate-y-1">
            ...
            <p className="text-center font-poppins text-sm text-white/90">
              Pantau status seluruh aset perusahaan, mulai dari aset yang
              tersedia hingga aset yang sedang dipinjam.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-Linear-A-from to-Linear-A-to p-8 shadow-lg transition-transform hover:-translate-y-1">
            ...
            <p className="text-center font-poppins text-sm text-white/90">
              Karyawan dapat dengan cepat meminjam aset yang dibutuhkan dan
              admin dapat dengan cepat mendapat notifikasi terkait semua
              aktivitas.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-Linear-A-from to-Linear-A-to p-8 shadow-lg transition-transform hover:-translate-y-1">
            ...
            <p className="text-center font-poppins text-sm text-white/90">
              Dapatkan wawasan mendalam dengan laporan lengkap mengenai
              inventaris, riwayat peminjaman, dan kondisi aset.
            </p>
          </div>
        </div>
      </section>
